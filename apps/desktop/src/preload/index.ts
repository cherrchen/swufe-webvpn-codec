...
const api: SwufeBridgeApi = {
  ...
  setCaptureMode: (mode) => ipcRenderer.invoke('swufe:setCaptureMode', mode),
  setCaptureProcesses: (patterns) => ipcRenderer.invoke('swufe:setCaptureProcesses', patterns),
  setDebugLogging: (enabled) => ipcRenderer.invoke('swufe:setDebugLogging', enabled),
  openCaptureWindow: () => ipcRenderer.invoke('swufe:openCaptureWindow'),
  openLogWindow: () => ipcRenderer.invoke('swufe:openLogWindow'),
  openAllowlistWindow: () => ipcRenderer.invoke('swufe:openAllowlistWindow'),
  getDebugLogs: () => ipcRenderer.invoke('swufe:getDebugLogs'),
  clearDebugLogs: () => ipcRenderer.invoke('swufe:clearDebugLogs'),
