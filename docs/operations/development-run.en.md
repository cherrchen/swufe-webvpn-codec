...
> Windows real-machine verification (TC-C02..C04, TC-D01..D04, TC-E01/E02/E03, TC-F01/F04, TC-G03/G04, TC-H01/H02, TC-B05) ran on **2026-09-23** on Windows 11 24H2 and passed; it surfaced `KI-015`..`KI-018`, all fixed, plus `KI-020` (tooling platform assumptions) — see [known-issues.md](../../specs/001-phase1-local-bridge/known-issues.md). The run and its command results are in the "M4 Windows 验收执行记录（2026-09-23）" section of [verification.md](../../specs/001-phase1-local-bridge/verification.md). `KI-019` has been reopened as `Open` pending diagnosis; see section 6 above for the temporary workaround.
