...
| [M7 iOS proxy plugins](milestones/M7-ios-proxy-plugins.en.md) | Loon / Stash plugins and shared JS core: P0 host capability → M1 core → M2 Loon → M3 Stash → M4 hardening/release | G-001 / G-002 / G-003 | TBD | Draft (spec 003 documentation merged; implementation not started; see [project-management.md](../../specs/003-ios-proxy-client-plugins/project-management.md)) |
...
| 003-ios-proxy-client-plugins | iOS proxy client plugins (Loon / Stash) | `IOS-REQ-*` (draft) + semantic alignment with REQ-002 / REQ-005 / REQ-006 / REQ-007, NFR-002 / NFR-003 | M7 | Draft (documentation merged; P0 host capability and session capture need real devices; see 003 verification.md) | [spec.md](../../specs/003-ios-proxy-client-plugins/spec.md) |
