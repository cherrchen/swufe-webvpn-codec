...
| [M4 acceptance](milestones/M4-acceptance.md) | macOS + Windows academic-affairs browser acceptance, defect burn-down | G-001 / G-002 / G-003 | TBD | In Progress (2026-09-21: on macOS everything except the browser acceptance passed and the defects are burned down into known-issues; the browser acceptance failed on `KI-011` and Windows is deferred by `KI-001`) |
