...
| [M7 iOS proxy plugins](milestones/M7-ios-proxy-plugins.en.md) | Stash / Loon plugins and shared JS core: P0 (done) → M1 core → M2 Stash → M3 Loon → M4 hardening/release; GitHub distribution | G-001 / G-002 / G-003 | TBD | In Progress (spec 003 `Approved`, Gate A passed; M1 not started; see [project-management.md](../../specs/003-ios-proxy-client-plugins/project-management.md)) |
...
| 003-ios-proxy-client-plugins | iOS proxy client plugins (Stash / Loon) | `IOS-REQ-*` (draft) + semantic alignment with REQ-002 / REQ-005 / REQ-006 / REQ-007, NFR-002 / NFR-003 | M7 | Approved (Gate A passed; Stash first host; see [spec.md §Status](../../specs/003-ios-proxy-client-plugins/spec.md)) | [spec.md](../../specs/003-ios-proxy-client-plugins/spec.md) |
