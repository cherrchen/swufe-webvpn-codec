...
| M7 iOS proxy plugins | [M7-ios-proxy-plugins.en.md](M7-ios-proxy-plugins.en.md) | Draft | [003-ios-proxy-client-plugins](../../../specs/003-ios-proxy-client-plugins/spec.md) | Loon/Stash plugins + shared JS core; spec 003 documentation merged, P0 host capability and session capture need real devices |
