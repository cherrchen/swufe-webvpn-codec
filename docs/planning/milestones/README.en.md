...
| M7 iOS proxy plugins | [M7-ios-proxy-plugins.en.md](M7-ios-proxy-plugins.en.md) | In Progress | [003-ios-proxy-client-plugins](../../../specs/003-ios-proxy-client-plugins/spec.md) | Stash/Loon plugins + shared JS core; spec 003 `Approved`, P0 Gate A passed, M1 pending |
