...
| 003-ios-proxy-client-plugins | iOS proxy client plugins (Stash / Loon) | `IOS-REQ-*` (draft) + semantic alignment with REQ-002 / REQ-005 / REQ-006 / REQ-007, NFR-002 / NFR-003 | Approved (Gate A passed; Stash first host; GitHub distribution; M1 pending; see [spec.md §Status](003-ios-proxy-client-plugins/spec.md)) | [spec.md](003-ios-proxy-client-plugins/spec.md) |
