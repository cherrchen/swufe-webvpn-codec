...
- 报告：acceptance-darwin-20260921-134602.md
- 生成时间：20260921-134602
...
```text
文件不存在：/tmp/m4-acceptance/config.json
```
...
```text
已收集敏感串：0 个（cookie 值 / wrdKey / wrdIv / 四个敏感头的值）
命中：0
```
